...
// in shoe_store/test/unit_test/auth_unit_test.dart.
...
import 'package:shoe_store/core/failure/failure.dart' as _i7;
import 'package:shoe_store/features/auth/domain/entity/user_entity.dart' as _i8;
...
class MockAuthUseCase extends _i1.Mock implements _i5.AuthUseCase {
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, bool>> checkUser(String? username) =>
      (super.noSuchMethod(
        Invocation.method(
          #checkUser,
          [username],
